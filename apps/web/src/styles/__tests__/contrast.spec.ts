...
const TEXT_PAIRS = [
  ...
  ['text', 'verified-soft', 'a figure on the tint that says it was checked'],
 ...
 * rule, so a tone nobody can see is a tone that is not there. `--color-line` is
 * deliberately absent: it divides regions, it does not identify a control, and
 * 1.4.11 does not ask a divider to be legible.
 */
const NON_TEXT_PAIRS = [
  ['text', 'surface', 'the focus ring on the application'],
  ['text', 'panel', 'the focus ring in the list'],
  ['line-strong', 'surface', 'the rule under an input'],
  ['line-strong', 'panel', 'the rule under a control in the list'],
  ['negative', 'surface', 'the rule under a rejected input'],
  ['line-strong', 'surface', 'the rule beside an informational alert'],
  ['positive', 'surface', 'the rule beside a positive alert'],
  ['warning', 'surface', 'the rule beside a warning alert'],
  ['negative', 'surface', 'the rule beside a negative alert'],
] as const;
